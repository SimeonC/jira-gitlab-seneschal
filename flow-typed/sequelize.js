...
declare module 'sequelize' {
   ...
   * @see  Model
   */
  declare export type BelongsToSetOne<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
    ...
    (
      ...
      options?: BelongsToSetOneOptions & InstanceSaveOptions<any>
    ): Promise<void>
  };
  ...
  declare export type BelongsToCreateOne<TInitAttributes> = {
    ...
    (
      ...
      options?: BelongsToCreateOneOptions &
        CreateOptions<any> &
        BelongsToSetOneOptions
    ): Promise<void>
  };
   ...
   * @see  Model
   */
  declare export type HasOneSetOne<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
    ...
    (
      newAssociation: ?(TInstance | TInstancePrimaryKey),
      options?: HasOneSetOneOptions &
        HasOneGetOneOptions &
        InstanceSaveOptions<any>
    ): Promise<void>
  };
  ...
  declare export type HasOneCreateOne<TInitAttributes> = {
    ...
    (
      values?: TInitAttributes,
      options?: HasOneCreateOneOptions &
        HasOneSetOneOptions &
        CreateOptions<any>
    ): Promise<void>
  };
   ...
   * @see  Model
   */
  declare export type HasManySetMany<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
   ...
   * @see  Model
   */
  declare export type HasManyAddMany<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
   ...
   * @see  Model
   */
  declare export type HasManyAddOne<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
    ...
    (
      newAssociation: TInstance | TInstancePrimaryKey,
      options?: HasManyAddOneOptions & InstanceUpdateOptions<any>
    ): Promise<void>
  };
   ...
   * @see  Model
   */
  declare export type HasManyCreateOne<
    TInitAttributes,
    TInstance: Model<any, TInitAttributes>
  > = {
    /**
     * Create a new instance of the associated model and associate it with this.
     * @param values The values used to create the association.
    ...
    (
      values?: TInitAttributes,
      options?: HasManyCreateOneOptions & CreateOptions<any>
    ): Promise<TInstance>
  };
   ...
   * @see  Model
   */
  declare export type HasManyRemoveOne<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
    ...
    (
      ...
      options?: HasManyRemoveOneOptions & InstanceUpdateOptions<any>
    ): Promise<void>
  };
   ...
   * @see  Model
   */
  declare export type HasManyRemoveMany<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
   ...
   * @see  Model
   */
  declare export type HasManyHasOne<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
    ...
    (
      ...
      options?: HasManyHasOneOptions & HasManyGetManyOptions
    ): Promise<boolean>
  };
   ...
   * @see  Model
   */
  declare export type HasManyHasMany<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
    ...
    (
      ...
      options?: HasManyHasManyOptions & HasManyGetManyOptions
    ): Promise<boolean>
  };
   ...
   * @see  Model
   */
  declare export type BelongsToManySetMany<
    TInstance: Model<any>,
    TInstancePrimaryKey,
   ...
   * @see  Model
   */
  declare export type BelongsToManyAddMany<
    TInstance: Model<any>,
    TInstancePrimaryKey,
    TJoinTableAttributes
  > = {
   ...
   * @see  Model
   */
  declare export type BelongsToManyAddOne<
    TInstance: Model<any>,
    TInstancePrimaryKey,
    TJoinTableAttributes
  > = {
   ...
   * @see  Model
   */
  declare export type BelongsToManyCreateOne<
    TInitAttributes,
    TInstance: Model<any, TInitAttributes>,
    TJoinTableAttributes
  > = {
   ...
   * @see  Model
   */
  declare export type BelongsToManyRemoveOne<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
    ...
    (
      oldAssociated: TInstance | TInstancePrimaryKey,
      options?: BelongsToManyRemoveOneOptions & InstanceDestroyOptions
    ): Promise<void>
  };
   ...
   * @see  Model
   */
  declare export type BelongsToManyRemoveMany<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
   ...
   * @see  Model
   */
  declare export type BelongsToManyHasOne<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
    ...
    (
      target: TInstance | TInstancePrimaryKey,
      options?: BelongsToManyHasOneOptions & BelongsToManyGetManyOptions
    ): Promise<boolean>
  };
   ...
   * @see  Model
   */
  declare export type BelongsToManyHasMany<
    TInstance: Model<any>,
    TInstancePrimaryKey
  > = {
    /**
  ...
  > extends Association<Source, Target> {
    ...
    get<PrimaryKey>(
      instances: Array<Source>,
      options?: FindOptions<TargetAttributes>
    ): Promise<{ [key: PrimaryKey]: Target }>;
    set<PrimaryKey>(
    ...
    create(
      sourceInstance: Source,
      values: TargetInitAttributes,
      options?: CreateOptions<TargetAttributes>
    ): Promise<Target>;
  }
  ...
  > extends Association<Source, Target> {
    ...
    set<PrimaryKey>(
      ...
      targetInstances: ArrayOrElement<PrimaryKey | Target>,
      options?: FindOptions<TargetAttributes> &
        UpdateRelatedOptions<TargetAttributes>
    ): Promise<Source>;
    add<PrimaryKey>(
      sourceInstance: Source,
      targetInstances: ArrayOrElement<PrimaryKey | Target>,
   ...
   *
   */
  declare export type UpsertOptions<TAttributes> = {} & FieldsOptions<
    TAttributes
  > &
    LoggingOptions &
    SearchPathOptions;
  ...
  declare type AsyncFn1<A> = (
    a: A,
    callback: (error?: Error) => any
  ) => ?Promise<void>;
  declare type AsyncFn2<A, B> = (
    a: A,
    b: B,
    callback: (error?: Error) => any
  ) => ?Promise<void>;
  declare type AsyncFn3<A, B, C> = (
    a: A,
    b: B,
    c: C,
    callback: (error?: Error) => any
  ...
  > {
     ...
     */
    options: ResolvedDefineOptions<this>;
     ...
     * @param options
     */
    schema(schema: string, options?: SchemaOptions): Class<this>;
     ...
     */
    scope(
      options?: string | ScopeOptions | $ReadOnlyArray<string | ScopeOptions>
    ): Class<this>;
    ...
    all<TCustomAttributes>(
      optionz?: FindOptions<TAttributes & TCustomAttributes>
    ): Promise<this[]>;
     ...
     */
    build(record?: TInitAttributes, options?: BuildOptions): this;
     ...
     */
    findOrInitialize(
      options: FindOrInitializeOptions<TInitAttributes>
     ...
     * @alias  hook
     */
    addHook(hookType: string, name: string, fn: Function): Class<this>;
    addHook(hookType: string, fn: Function): Class<this>;
    hook(hookType: string, name: string, fn: Function): Class<this>;
    hook(hookType: string, fn: Function): Class<this>;
     ...
     * @param name
     */
    removeHook(hookType: string, name: string): Class<this>;
     ...
     */
    beforeValidate(name: string, fn: AsyncFn2<this, Object>): void;
    beforeValidate(fn: AsyncFn2<this, Object>): void;
     ...
     * @param fn A callback function that is called with instance, options
     */
    afterValidate(name: string, fn: AsyncFn2<this, Object>): void;
    afterValidate(fn: AsyncFn2<this, Object>): void;
    ...
    validationFailed(
      name: string,
      fn: AsyncFn3<this, Object, ValidationError>
    ): void;
    validationFailed(fn: AsyncFn3<this, Object, ValidationError>): void;
     ...
     */
    beforeCreate(name: string, fn: AsyncFn2<this, Object>): void;
    beforeCreate(fn: AsyncFn2<this, Object>): void;
     ...
     * @param fn A callback function that is called with attributes, options
     */
    afterCreate(name: string, fn: AsyncFn2<this, Object>): void;
    afterCreate(fn: AsyncFn2<this, Object>): void;
     ...
     * @alias  beforeDelete
     */
    beforeDestroy(name: string, fn: AsyncFn2<this, Object>): void;
    beforeDestroy(fn: AsyncFn2<this, Object>): void;
    beforeDelete(name: string, fn: AsyncFn2<this, Object>): void;
    beforeDelete(fn: AsyncFn2<this, Object>): void;
     ...
     * @alias  afterDelete
     */
    afterDestroy(name: string, fn: AsyncFn2<this, Object>): void;
    afterDestroy(fn: AsyncFn2<this, Object>): void;
    afterDelete(name: string, fn: AsyncFn2<this, Object>): void;
    afterDelete(fn: AsyncFn2<this, Object>): void;
     ...
     * @param fn A callback function that is called with instance, options
     */
    beforeUpdate(name: string, fn: AsyncFn2<this, Object>): void;
    beforeUpdate(fn: AsyncFn2<this, Object>): void;
     ...
     * @param fn A callback function that is called with instance, options
     */
    afterUpdate(name: string, fn: AsyncFn2<this, Object>): void;
    afterUpdate(fn: AsyncFn2<this, Object>): void;
    ...
    beforeUpsert(
      name: string,
      fn: AsyncFn2<TInitAttributes, Object>
    ): void;
    beforeUpsert(fn: AsyncFn2<TInitAttributes, Object>): void;
    ...
    afterUpsert(
      name: string,
      fn: AsyncFn2<boolean | [this, boolean], Object>
    ): void;
    afterUpsert(fn: AsyncFn2<boolean | [this, boolean], Object>): void;
     ...
     */
    beforeBulkCreate(name: string, fn: AsyncFn2<this[], Object>): void;
    beforeBulkCreate(fn: AsyncFn2<this[], Object>): void;
     ...
     */
    afterBulkCreate(name: string, fn: AsyncFn2<this[], Object>): void;
    afterBulkCreate(fn: AsyncFn2<this[], Object>): void;
     ...
     */
    afterFind(name: string, AsyncFn2<this | this[], Object>): void;
    afterFind(AsyncFn2<this | this[], Object>): void;
    ...
    beforeDefine(
      name: string,
      fn: AsyncFn2<DefineAttributes, Object>
    ): void;
     ...
     */
    afterDefine(name: string, fn: AsyncFn1<Model<this, any>>): void;
    afterDefine(fn: AsyncFn1<Model<this, any>>): void;
     ...
     */
    beforeBulkSync(name: string, fn: AsyncFn1<SyncOptions>): void;beforeBulkSync(fn: AsyncFn1<SyncOptions>): void;
     ...
     * @param fn A callback function that is called with options passed to sequelize.sync
     */
    statiBulkSync(name: string, fn: AsyncFn1<SyncOptions>): void;
    ...
    getAssociations<Target: Model<any>>(
      model: Class<Target>
    ): Array<Association<this, Target>>;
    getAssociationForAlias<Target: Model<any>>(
      model: Class<Target>,
      alias: ?string
    ): ?Association<this, Target>;

    associations: { [name: string]: Association<this, any> };
    tableName: string;
    rawAttributes: { [name: string]: Attribute };
    tableAttributes: { [name: string]: Attribute };
    attributes: { [name: string]: Attribute };
    primaryKeys: { [name: string]: Attribute };
    primaryKeyAttributes: Array<string>;
    ...
    fieldRawAttributesMap: { [name: string]: string };
    fieldAttributesMap: { [name: string]: string };
    ...
    get(
      ...
      options?: { plain?: boolean, clone?: boolean, raw?: boolean }
    ): any;
    get(options?: {
      plain?: boolean,
      clone?: boolean,
   ...
   */
    ...
    static validationFailed(
      name: string,
      fn: AsyncFn3<Model<any>, Object, ValidationError>
    ): void;
    static validationFailed(
      fn: AsyncFn3<Model<any>, Object, ValidationError>
    ): void;
    ...
    static beforeDelete(name: string, fn: AsyncFn2<Model<any>, Object>): void;
    ...
    static afterDelete(name: string, fn: AsyncFn2<Model<any>, Object>): void;
    ...
    static afterFind(
      name: string,
      AsyncFn2<Model<any> | Model<any>[], Object>
    ): void;
    ...
    static afterDefine(
      name: string,
      fn: AsyncFn1<Model<Model<any>, any>>
    ): void;
   ...
   */
    ...
    beforeDelete(name: string, fn: AsyncFn2<Model<any>, Object>): void;
    ...
    afterDelete(name: string, fn: AsyncFn2<Model<any>, Object>): void;
   ...
   */
    define<
      TAttributes,
      TPlainAttributes,
      TInstance: Model<TAttributes, TPlainAttributes>
    >(
      modelName: string,
      attributes: DefineAttributes,
  ...
  declare export type TransactionIsolationLevelReadUncommitted =
    'READ_UNCOMMITTED';

  declare export type TransactionIsolationLevelReadCommitted = 'READ_COMMITTED';

  declare export type TransactionIsolationLevelRepeatableRead =
    'REPEATABLE_READ';
  ...
  declare export type TransactionType =
